...
**Answer** This webpage details information about the 2017 North American Industry Classification System.
...
**Answer** I see the source code of the webpage. 
...
**Answer** The codeblock created a list of 2 under naics_industry.
...
**Answer** When clicking on naics_industry, it shows the general page structure of the webpage.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** The element inspector displays code from the table.
...
**Answer**
The code create six different outputs. 
```{r}
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** The code made the naics_industry a list of 6.
...
**Answer** The first dataframe only has 4 rows and 3 columns. It details the conversions and the dates they occured on.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
This dataframe lists sector numbers and the corresponding sector description. 
### Task 16: Load image
...
**Answer** The output below displays the correct dataframe that includes the sector number and sector description.
...
**Answer** The dataframe now only has 20 rows, removing the source url in the 21st row.
...
**Answer** The output displays a dataframe with the sector numbers and corresponding sector descriptions.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** The webpage displays information about the utilities sector.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** The output displays html code from the webpage.
```{r}
...
**Answer** The output displays the html code for the emplyoment info page. 
...
**Answer** The output organizes the html code as a dataframe with 6 rows and columns.
...
**Answer**
The table displays employment of all employees for June 2021. 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** This webpage displays information about the mining, quarrying, and oul and gas extraction sector. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** This webpage displays info about the construction sector. 
...
**Answer** The output lists each sector.
```{r}
...
**Answer** The output created a value of "lists_of_sectors" in the environment window. 
```{r}
...
**Answer** The output created a list of the sectors. The codeblock created a loop in list_of_sectors.
```{r}
...
**Answer** The output displays an error that the oject "sector_list" is not found. 
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** The codeblock created a new value of "x" in the environment window.
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** the output displays an error that the object "sector_name" is not found.
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer** The output makes a list of values 1 through 10 in numerical order. 
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer** The output still has 20 rows and displays all of the sector numbers and sector descriptions. 
...
**Answer** The output notes that the code created a list of umbers starting at 1 and ending at 20.
...
**Answer** The output created a loop of values from 1 to 20 listed in numerical order. 
...
**Answer** The output contains a table consisting of employment inJune 2021.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** the output displays a table with the sector number and sector descriptions. 
```{r}
# Define url of page we want to scrape
...
**Answer** the output adds another column listed "sector_url."
...
**Answer**
The output displays the id as a new column listed "sector_xpath_id."
```{r}
...
**Answer** Thr output removed the public administration row. 
...
**Answer** The output displays a seperate table for each sector. 
...
**Answer** The output displays a loop of a list with each url and xpath value. 
```{r}
...
**Answer** The output produced 19 tables. 
...
**Answer** The output produced cleaned tables by getting rid of information we don't need. 
...
**Answer** The output added columns to display the sector code and name. 
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer**
The output removed the comma from June 2021 and changed it from a character to a number.
```{r}
...
**Answer** The output binded the employment_info dataframe to the new dataframe.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** The webpage displays info about the mining, quarrying, and oil and gas extraction sector. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** The wbepage displays the unemployment rate under the agriculture sector.
...
**Answer** The output adds N/A to the agriculture row under jun_2021_employees.
