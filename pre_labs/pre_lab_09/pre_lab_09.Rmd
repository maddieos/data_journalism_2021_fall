...
**Answer**
Line 56 is taking the ppp_maryland data and making it a new dataframe called maryland_ppp_top_counties. Line 56 is grouping all of the data by the project_county_name. Like 58-60 is telling the new dataframe to list the amount if total loans for each county. Line 61 is arranging the total loans from greatest to least. 
```{r}
...
**Answer**
There is a gray box that is displayed after running this code.
```{r}
maryland_ppp_top_counties %>%
  ggplot()
```
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer**
The following code created a bar graph showing the count of total loans for each county.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
...
**Answer**
The bar graph now organizes the total loans from least to greatest on the graph.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
The county names have moved to the y-axis and the total loan amount moved to the x-axis.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The theme changed to the minimal theme, making the style of the graph much cleaner. 
...
**Answer** The style of the graph changed, now there is a light blue background, a different style graph, and a different font.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** This code added a title to the graph and a source attribution below the graph. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** I see a dataframe detailing the total loans approved on a certain date. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** There is a line graph with total loan values on the y axis and the date approved as the x axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The scale of the x-axis is now monthly.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**The code made the dates along the x-axis visbile, so they are angled better to read. 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
