...
**Answer** Some of the cities are listed in all capital letters, splitting up the data into seperate rows. There is also mispelling of different cities, further separating the data.
...
**Answer** The refinr package changed cities that were listed in all capital letters to grammatially correct capitalizaiton. 
...
**Answer**
The refinr function changed mispelled cities to the correct spelling, for example the mispelling of "Aberdeen."The function also capitalized the first letter in cities. It also changed all capitlized cities to gramatically correct capitalizaiton. 
```{r}
cleaned_md_loans %>%
...
**Answer** The changes are not substantially different from the previous method.
