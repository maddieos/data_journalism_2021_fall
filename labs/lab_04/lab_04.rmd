...
**A1** The top 5 industries with the most PPP applications in Maryland are taxi services, beauty salons, full-service resturants, offices of real estate agents and brokers, and all other personal services. 
...
**A2** The top 5 industries with the most PPP applications in Maryland where the loan amount is more than $150,000 are full-service resturants, offices of physicians (except mental health specialists), plumbing, heating, and air-conditioning contractors, offices of dentisits, and commercial and institutional building construction.
...
**A3** 20850 has at least 20 percent non-Hispanic Asian population with the largest sum of PPP loans. 
...
**A4** 20850 is the Maryland zip code with the largest sum of loans when the applicant was Asian. The percentage of the non-Hispanic Asian population in 20850 is 23.5 percent. 
...
**A5** [write your answer here] The fact that a lot of loan applicants did not report their race in the application may explain why so little of loans belonged to Asian applicants. 
...
**A7** From a newsworthiness standpoint, the executive and legislative offices seem to be most worthy of further exploration, because it seems strange that these offices would only be receiving one loan. 
